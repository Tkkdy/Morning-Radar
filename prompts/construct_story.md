...
claim_type、evidence_scope、claim_scope 和 scope_supported。Claim Scope 不得大于 Evidence Scope；
无法支持时 scope_supported=false，调用方会拒绝该 Story。

官方主体可以证明自己的发布、API 能力、价格和 rollout 声明，但不能独自证明全球首次、客观
